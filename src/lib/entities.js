...
function Entities(noa, opts) {
  ...
  this.names.position = this.createComponent(
    require("../components/position")(noa)
  );
  this.names.physics = this.createComponent(
    require("../components/physics")(noa)
  );
  this.names.followsEntity = this.createComponent(
    require("../components/followsEntity")(noa)
  );
  this.names.mesh = this.createComponent(require("../components/mesh")(noa));
  this.names.shadow = this.createComponent(
    require("../components/shadow")(noa, shadowDist)
  );
  this.names.collideTerrain = this.createComponent(
    require("../components/collideTerrain")(noa)
  );
  this.names.collideEntities = this.createComponent(
    require("../components/collideEntities")(noa)
  );
  this.names.smoothCamera = this.createComponent(
    require("../components/smoothCamera")(noa)
  );
  this.names.movement = this.createComponent(
    require("../components/movement")(noa)
  );
  this.names.receivesInputs = this.createComponent(
    require("../components/receivesInputs")(noa)
  );
  this.names.fadeOnZoom = this.createComponent(
    require("../components/fadeOnZoom")(noa)
  );
  ...
  this.getPhysicsBody = function(id) {
 ...
 * @param height..
 */
Entities.prototype.add = function(
  position,
  width,
  height, // required
  mesh,
