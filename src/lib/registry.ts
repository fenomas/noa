...
/** currently stored in chunks as int8 */
const MAX_BLOCK_IDS = 255
...
export class Registry {
    ...
    registerBlock = (id: number, options: Partial<IBlockOptions>) => {
        ...
        if (id < 1 || id > MAX_BLOCK_IDS) {
            throw new Error(`Block id exceeds max: ${id}`)
        }
