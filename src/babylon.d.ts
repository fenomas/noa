declare module BABYLON {
  ...
  class Engine {
    ...
    private static HALF_FLOAT_OES;
    private static RGBA16F;
    private static RGBA32F;
    ...
    createTexture(
      ...
      onLoad?: () => void,
      onError?: () => void,
      buffer?: ArrayBuffer | HTMLImageElement,
     ...
     */
    getOrAddExternalDataWithFactory<T>(
      key: string,
      factory: (k: string) => T
    ): T;
    /**
    ...
    private _getWebGLTextureType(type);
    private _getRGBABufferInternalSizedFormat(type);
...
declare module BABYLON {
  ...
  class Scene implements IAnimatable {
    ...
    private _externalData;
    private _uid;
    offscreenRenderTarget: RenderTargetTexture;
    /**
     * @constructor
    ...
    createDefaultSkybox(environmentTexture?: BaseTexture, pbr?: boolean): Mesh;
    private _getByTags(list, tagsQuery, forEach?);
    getMeshesByTags(
      tagsQuery: string,
      forEach?: (mesh: AbstractMesh) => void
    ): Mesh[];
    getCamerasByTags(
      tagsQuery: string,
      forEach?: (camera: Camera) => void
    ): Camera[];
    getLightsByTags(
      tagsQuery: string,
      forEach?: (light: Light) => void
    ): Light[];
    getMaterialByTags(
      tagsQuery: string,
      forEach?: (material: Material) => void
    ): Material[];
    /**
...
declare module BABYLON {
  class DirectionalLight extends ShadowLight {
     ...
     * Returns the DirectionalLight Shadow projection matrix.
     */
    protected _setDefaultFixedFrustumShadowProjectionMatrix(
      matrix: Matrix,
      viewMatrix: Matrix
    ): void;
    /**
...
declare module BABYLON {
  ...
  abstract class ShadowLight extends Light implements IShadowLight {
    protected abstract _setDefaultShadowProjectionMatrix(
      matrix: Matrix,
      viewMatrix: Matrix,
      renderList: Array<AbstractMesh>
    ): void;
...
declare module BABYLON {
  class PushMaterial extends Material {
    ...
    protected _mustRebind(
      scene: Scene,
      effect: Effect,
      visibility?: number
    ): boolean;
    markAsDirty(flag: number): void;
    protected _markAllSubMeshesAsDirty(
...
declare module BABYLON {
  ...
  class SphericalPolynomial {
    ...
    static getSphericalPolynomialFromHarmonics(
...
declare module BABYLON {
  ...
  class VertexData {
     ...
     */
    static CreateLineSystem(options: { lines: Vector3[][] }): VertexData;
    /**
...
declare module BABYLON {
  ...
  class ModelShape {
    ...
    constructor(
      ...
      shape: Vector3[],
      shapeUV: number[],
      posFunction: (particle: SolidParticle, i: number, s: number) => void,
      vtxFunction: (particle: SolidParticle, vertex: Vector3, i: number) => void
    );
  }
}
...
declare module BABYLON.Internals {
  ...
  class DDSTools {
    ...
    private static GetRGBAArrayBuffer(
      width,
      height,
      dataOffset,
      dataLength,
    ...
    private static GetRGBArrayBuffer(
      width,
      height,
      dataOffset,
      dataLength,
    ...
    private static GetLuminanceArrayBuffer(
      width,
      height,
      dataOffset,
      dataLength,
...
declare module BABYLON {
  ...
  function serializeAsVector2(
    sourceName?: string
  ): (target: any, propertyKey: string | symbol) => void;
  function serializeAsVector3(
    sourceName?: string
  ): (target: any, propertyKey: string | symbol) => void;
  function serializeAsMeshReference(
    sourceName?: string
  ): (target: any, propertyKey: string | symbol) => void;
  function serializeAsColorCurves(
    sourceName?: string
  ): (target: any, propertyKey: string | symbol) => void;
...
declare module BABYLON {
  ...
  class PoseEnabledControllerHelper {
    static InitiateController(
      vrGamepad: any
    ): OculusTouchController | ViveController;
  }
  ...
  abstract class WebVRController extends PoseEnabledController {
    ...
    constructor(vrGamepad: any);
    update(): void;
    protected abstract handleButtonChange(
      buttonIdx: number,
    ...
    abstract initControllerMesh(
      scene: Scene,
      meshLoaded?: (mesh: AbstractMesh) => void
    ): any;
  ...
  class ViveController extends WebVRController {
    ...
    readonly onLeftButtonStateChangedObservable: Observable<
      ExtendedGamepadButton
    >;
    readonly onRightButtonStateChangedObservable: Observable<
      ExtendedGamepadButton
    >;
    readonly onMenuButtonStateChangedObservable: Observable<
      ExtendedGamepadButton
    >;
    /**
     * Vive mapping:
...
declare module BABYLON {
  class Gamepads<T extends Gamepad> {
    ...
    constructor(
      ongamedpadconnected: (gamepad: T) => void,
      ongamedpaddisconnected?: (gamepad: T) => void
    );
    dispose(): void;
...
declare module BABYLON.Internals {
  class TGATools {
    ...
    static _getImageDataGrey16bits(
      header: any,
      palettes: Uint8Array,
      pixel_data: Uint8Array,
      y_start: number,
...
declare module BABYLON {
  ...
  class Tools {
    ...
    static Vector2ArrayFeeder(
      array: Array<Vector2> | Float32Array
    ): (i: number) => Vector2;
    ...
    static _StartPerformanceCounterDisabled(
      counterName: string,
      condition?: boolean
    ): void;
    static _EndPerformanceCounterDisabled(
      counterName: string,
      condition?: boolean
    ): void;
...
declare module BABYLON {
  ...
  abstract class PBRBaseMaterial extends BABYLON.PushMaterial {
     ...
     */
    protected _cameraExposure: number;
    /**
     * The camera contrast used on this material.
     * This property is here and not in the camera to allow controlling contrast without full screen post process.
     */
    protected _cameraContrast: number;
    /**
     * Color Grading 2D Lookup Texture.
     * This allows special effects like sepia, black and white to sixties rendering style.
     */
    protected _cameraColorGradingTexture: BaseTexture;
    /**
     * The color grading curves provide additional color adjustmnent that is applied after any color grading transform (3D LUT).
     * They allow basic adjustment of saturation and small exposure adjustments, along with color filter tinting to provide white balance adjustment or more stylistic effects.
     * These are similar to controls found in many professional imaging or colorist software. The global controls are applied to the entire image. For advanced tuning, extra controls are provided to adjust the shadow, midtone and highlight areas of the image;
     * corresponding to low luminance, medium luminance, and high luminance areas respectively.
     */
    protected _cameraColorCurves: ColorCurves;
     ...
     */
    protected _useEmissiveAsIllumination: boolean;
    /**
     ...
     */
    protected _useScalarInLinearSpace: boolean;
    /**
...
declare module BABYLON {
  ...
  class ColorGradingTexture extends BaseTexture {
     ...
     */
    static PrepareUniformsAndSamplers(
      uniformsList: string[],
      samplersList: string[]
    ): void;
    /**
...
declare module BABYLON {
  ...
  class HDRCubeTexture extends BaseTexture {
     ...
     */
    static generateBabylonHDROnDisk(
      url: string,
      size: number,
      onError?: () => void
    ): void;
...
declare module BABYLON {
  class RawTexture extends Texture {
    ...
    static CreateLuminanceAlphaTexture(
      data: ArrayBufferView,
      width: number,
      height: number,
      scene: Scene,
...
declare module BABYLON {
  class VideoTexture extends Texture {
    ...
    constructor(
      name: string,
      urlsOrVideo: string[] | HTMLVideoElement,
      scene: Scene,
      generateMipMaps?: boolean,
      invertY?: boolean,
      samplingMode?: number
...
declare module BABYLON.Internals {
  ...
  class CubeMapToSphericalPolynomialTools {
     ...
     */
    static ConvertCubeMapToSphericalPolynomial(
...
declare namespace BABYLON.Internals {
  ...
  class PMREMGenerator {
    ...
    private determineFilterExtents(
      centerTapDir,
      srcSize,
      bboxSize,
      filterExtents
    );
    private processFilterExtents(
      centerTapDir,
      dotProdThresh,
      filterExtents,
      srcCubeMap,
...
declare module BABYLON {
  class DefaultRenderingPipeline extends PostProcessRenderPipeline
    implements IDisposable, IAnimatable {
    private _scene;
...
declare module BABYLON {
  class StandardRenderingPipeline extends PostProcessRenderPipeline
    ...
    private _createGaussianBlurPostProcesses(
      scene,
      ratio,
      indice,
      blurWidthKey?
