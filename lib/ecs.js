...
ECS.prototype.addEntityComponent = function (entID, comp) {
	return this._ecs.addComponentsToEntity([comp], entID)
}
...
ECS.prototype.addProcessor = function (processor) {
	if (!processor.update) throw new Error('Processor should be shaped like { update:fcn }')
