...
// So even if props are present, assume unsupported until a mouse event occurs.
// TODO: check if this breaks badly on hybrid mouse/touch environments
function detectPointerLock(self) {
  var lockElementExists = 
    ('pointerLockElement' in document) ||
    ('mozPointerLockElement' in document) ||
    ('webkitPointerLockElement' in document)
  if (!lockElementExists) return  // supported flag already initialized to false
