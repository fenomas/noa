...
World.prototype.tick = function () {
    ...
    if (!okay) this._lastPlayerChunkID = '' // TODO remove
}
...
World.prototype.invalidateAllChunks = function () {
    var toInval = this._chunkIDsInMemory.concat(this._chunkIDsPendingCreation)
...
function removeChunk(world, i, j, k) {
    ...
    world.emit('chunkBeingRemoved', id, chunk.array, chunk.userData)
    chunk.dispose()
