...
Chunk.prototype.set = function (x, y, z, id) {
    ...
    // call handlers
    var oldHandler = this._handlersLookup[oldIDnum].onDestroy
    if (oldHandler) oldHandler(this.x + x, this.y + y, this.z + z)
    var newHandler = this._handlersLookup[id].onCreate
    if (newHandler) newHandler(this.x + x, this.y + y, this.z + z)
