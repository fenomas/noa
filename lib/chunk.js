...
Chunk.prototype.set = function( x, y, z, id ) {
  ...
  id = packID(id, this._solidLookup, this._opaqueLookup, this._objectMeshLookup)
  this._unpaddedView.set( x,y,z, id )
  // mark terrain dirty unless neither block was terrain
  if (isTerrain(oldID) || isTerrain(id)) this._terrainDirty = true
}
