...
proto.createComponent = function (comp, dataRemove) {
	...
	if (comp.processor) {
		...
		this.processors[name].update = function(dt) {
...
function setupComponents(self) {
	...
	comps.mesh = require('../components/mesh')(self.noa)
	comps.player = require('../components/player')(self.noa)
	comps.collideTerrain = require('../components/collideTerrain')(self.noa)
	comps.collideEntities = require('../components/collideEntities')(self.noa)
	comps.countdown = require('../components/countdown')(self.noa)
	comps.sprite = require('../components/sprite')(self.noa)
	
	self.createComponent( comps.aabb )
	self.createComponent( comps.shadow )
	self.createComponent( comps.physics )
	self.createComponent( comps.mesh)
	self.createComponent( comps.player )
	self.createComponent( comps.collideTerrain )
	self.createComponent( comps.collideEntities )
	self.createComponent( comps.countdown )
	self.createComponent( comps.sprite )
	
	// internal use
	comps.autoStepping = require('../components/autostepping')(self.noa)
