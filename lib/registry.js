...
Registry.prototype.registerObjectBlock = function(name, meshName, properties,
  ...
  var meshID = this.getMeshID(meshName)
...
Registry.prototype.getMeshID = function(name) {
  return this._meshIDs[name]
}
