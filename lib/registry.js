 ...
 *                              onOver: function(x, y, z), 
 *                              onOut: function(x, y, z)    }
 ...
 *  * onCreate(): block event handler
 *  * onDestroy(): block event handler
 *  * onOver(): block event handler
 *  * onOut(): block event handler
*/
...
Registry.prototype.registerBlock = function (id, _options) { // material, properties, solid, opaque, fluid) {
    ...
    // event callbacks
    this._blockHandlers[id] = {
        onCreate: opts.onCreate || null,
        onDestroy: opts.onDestroy || null,
        onCustomMeshCreate: opts.onCustomMeshCreate || null,
        onOver: opts.onOver || null,
        onOut: opts.onOut || null,
    }
